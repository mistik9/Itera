...
function MyApps() {
  ...
  return (
    <motion.section initial="hidden" whileInView="visible" viewport={{ amount: 0.3, once: true }} className="section my-apps" id="my-apps">
      <motion.h2 custom={1} variants={textAnimation} className="section__title">
        Наши приложения
      </motion.h2>
