    ...
    return (
        <div className="my-app">
            ...
            <ul className="my-app__list">
                <li className="my-app__list-item"><span className="my-app__text-span">Диалоги</span><p className="my-app__text"> По каждому диалогу на Дром создается сделка, в которую предается: товар по которому написал пользователь (картинка, название, описание), ссылка на объявление, ссылка на профиль пользователя, название сделки обновляется в соответствии с названием товара. При отправке нескольких изображений, отправка происходит одним сообщением.</p></li>
                <li className="my-app__list-item"><span className="my-app__text-span">Сделки</span><p className="my-app__text"> По каждой заключенной сделке на Дром создается сделка на портале Битрикс24, куда переносятся данные по отправке заказа и товары.</p></li>
                <li className="my-app__list-item"><span className="my-app__text-span">Товары</span><p className="my-app__text"> Все товары из диалогов и сделок попадают в Битрикс24. При установке приложения, для них создаётся отдельный раздел в каталоге.</p></li>
            </ul>
