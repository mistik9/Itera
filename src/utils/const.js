...
export const about_autoload =
  "Приложение позволяет формировать прайс для любой категории товаров и услуг Avito. Прайс формируется из товаров, которые загружены на Вашем портале. Настройки позволяют соотнести поля товаров с полями прайса, исходя из требований Avito. При обновлении, добавлении или удалении товаров на портале прайс переформируется автоматически. При формировании прайса вы получаете ссылку на файл, и ссылку по которой вы можете проверить его на Avito. После чего приложение запишет эту ссылку в настройки автозагрузки Avito.";
