...
export const faq_avito = [
    ...
    },
    {
        ...
        text: "В рамках подписки на Битрикс24.Маркет Плюс доступно подключение двух аккаунтов Авито. Возможно подключение дополнительных аккаунтов, стоимость уточняйте у поддержки приложения",
    ...
    {
        title:
            "Возможно ли получение сообщений на портале отправленных напрямую в Авито?",
        text: "В текущей версии приложение данная функция не реализована.",
